...
from kvault import LogEntry, MatchCandidate
...
class OrchestratorConfig:
    ...
    max_retries: int = 3  # Retries per step with exponential backoff
    timeout_seconds: int = 900  # Per-step timeout (15 minutes, increased from 10)
    max_content_chars: int = 8000  # Truncate content beyond this (prevents context bloat)
